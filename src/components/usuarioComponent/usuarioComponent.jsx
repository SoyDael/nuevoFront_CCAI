        ...
        <>
            ...
            <div className=" rounded-md p-4 relative  border shadow-2xl bg-gray-800 border-gray-700   shadow-blue-500/50  ">
                ...
                <div class="flex flex-col items-center justify-center space-y-6">
                    <input type="text" id="password" name="password" placeholder="Correo" class="w-80 appearance-none rounded-full border-0 bg-slate-700 p-2 px-4 focus:bg-slate-800 focus:ring-2 focus:ring-orange-500" />
                    <div>
                        <input type="password" id="confirm_password" name="confirm_password" placeholder="Contraseña" class="w-80 appearance-none rounded-full border-0 bg-slate-700 p-2 px-4 focus:bg-slate-800 focus:ring-2 " />
