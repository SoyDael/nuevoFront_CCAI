                    ...
                    <form onSubmit={handleSubmit}>
                        <div class="flex flex-col  justify-center items-center  space-y-6">
                            ...
                            <div>
                                ...
                                class="w-80 appearance-none rounded-full border-0 bg-slate-400 p-2 px-4 focus:bg-slate-600 focus:ring-2 " 
                                value={password}
                            ...
                            <div class="relative inline-flex">
                                ...
                                <select 
                                class="w-80 appearance-none rounded-full border-0 bg-slate-400 p-2 px-4 focus:bg-slate-700 focus:ring-2 text-white "
                                value={userType}
