                ...
                <div className='lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2'>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div class="flex flex-col  justify-center items-center  space-y-6">
                            ...
                            name="email" 
                            placeholder="Correo " 
                            class="w-80 appearance-none rounded-full border-0 bg-slate-600 p-2 px-4 focus:bg-slate-400 focus:ring-2 focus:ring-orange-500" 
                            required 
                            value={email}
                            ...
                            <div>
                                ...
                                class="w-80 appearance-none rounded-full border-0  bg-slate-600 p-2 px-4 focus:bg-slate-400 focus:ring-2 " 
                                value={password}
                            ...
                            <div class="relative inline-flex">
                                ...
                                <select 
                                class="w-80 appearance-none rounded-full border-0 bg-slate-600 p-2 px-4 focus:bg-slate-400 focus:ring-2 text-white"
                                value={userType}
                        ...
                        <div className="mb-6 text-gray-800 text-center">
                            <button
                                type='submit'
                                className='bg-slate-500 text-center hover:bg-gray-500  text-white font-semibold rounded-full py-2 px-4 w-middle'
                                >
                                Iniciar Sesión
                            </button>
                        </div>
