...
const redireccionarListadoAlumnos = () => {
    ...
    return (
        <>
            ...
            <div className="relative w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-word border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl  shadow-blue-500/50">
                <div className="pb-6">
            ...
            <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                ...
                <div className="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono text-xl">{perfilInvestigador[0]?.nombres} {perfilInvestigador[0]?.apellido_p} {perfilInvestigador[0]?.apellido_m}</div>
            </div>
