...
import { asignarActividadExterno } from '../../../api/APIS';
import SlideBarInvestigadores from '../../SlideBar/SlideBarInvestigadores';


const AsigActExterno = () => {
    const navigate = useNavigate();

    const { id_proyecto, id_estancia, id_estancia_residente, correo_residente_estancia } = useParams();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await asignarActividadExterno(actividad, id_proyecto, id_estancia, id_estancia_residente, correo_residente_estancia);
