        ...
        <div className="relative w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-word  bg-slate-800 border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl  shadow-blue-500/50">
                <div class="pb-6">
                    <div class="text-center my-4">
                        ...
                        <div class="py-2">
                            <h3 class="font-bold text-2xl text-slate-300 dark:text-dark mb-1">Bienvenido(a) <br></br> {perfilEstudiante[0]?.nombres} {perfilEstudiante[0]?.apellido_p} {perfilEstudiante[0]?.apellido_m} </h3>
                            <br></br>
                            <div class="inline-flex text-slate-300 dark:text-gray-300 items-center">
                                <h3 class="text-2xl text-slate-300 dark:text-dark mb-1">Division: <br></br> {perfilEstudiante[0]?.division}</h3>
                            </div>
                        </div> 
                        <div class="py-2">
                            <div class="inline-flex text-slate-300 dark:text-gray-300 items-center">
                                <h3 class="text-2xl text-slate-300 dark:text-dark mb-1">Matricula:<br></br> {perfilEstudiante[0]?.matricula}</h3>
                            </div>
                        </div>
                        <div class="py-2 items-center">
                            <div class="inline-flex justify-center text-gray-700 dark:text-gray-300 items-center">
                                <h3 class="text-2xl text-slate-300 dark:text-dark mb-1">Correo: {perfilEstudiante[0]?.correo}</h3>
                            </div>
                        </div>
                        <div class="py-2 items-center">
                            <div class="inline-flex justify-center text-slate-300 dark:text-gray-300 items-center">
                                <h3 class="text-2xl text-slate-300 dark:text-dark mb-1">Correo Adicional: {perfilEstudiante[0]?.correo_adicional}</h3>
                            </div>
                        </div>
                        <div class="py-2 items-center">
                            <div class="inline-flex justify-center text-slate-300 dark:text-gray-300 items-center">
                                <h3 class="text-2xl text-slate-300 dark:text-dark mb-1">Telefono:<br></br> {perfilEstudiante[0]?.telefono}</h3>
                            </div>
                        </div>
                    </div>
