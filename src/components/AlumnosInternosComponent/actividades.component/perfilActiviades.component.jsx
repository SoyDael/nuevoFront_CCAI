        ...
        <>
            ...
            <div class="flex min-h-screen items-center justify-center bg-slate-400  from-gray-700 via-gray-800 to-gray-900">
                <div className="relative overflow-x-auto  sm:rounded-lg bg-slate-800 shadow-lg shadow-blue-500/100">
                    <div class="">
                        <h3 className="border-blue-gray-100 bg-blue-gray-50/50 font-bold text-lg text-white text-center p-4">Bienvenido(a) tu proyecto asignado es: </h3>
                            ...
                            <tbody>
                                {actividadesForm.map((proyecto) => (
                                    <tr key={proyecto.id_actividad}>
                                        ...
                                        <td class="p-4 border-b border-blue-gray-50">
                                            <p class="block antialiased font-sans text-sm leading-normal text-white font-normal">{proyecto.correo_estudiante}</p>
                                        </td>
                                        <td class="p-4 border-b border-blue-gray-50">
